...
#%%
#wrap up the results
df_1 = pd.DataFrame((dt_model, lr_model, lda_model, rfc_model, knn_model), columns=('Test Accuracy', 'Train Accuracy', 'Model', 'Number of Features', 'Features')).sort_values('Test Accuracy', ascending=False)
#%%
